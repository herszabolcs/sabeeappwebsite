        ...
        <div className="flex flex-col gap-5 md:flex-row md:gap-12 lg:gap-20">
          ...
          <div className="w-full max-w-lg">
            <p className="md:text-md">
              Every message lands in one inbox. The AI handles the routine
              questions while you handle what matters. When a guest needs a
              human touch, the handoff is seamless.
            </p>
