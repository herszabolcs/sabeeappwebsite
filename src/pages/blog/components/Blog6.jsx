        ...
        <div className="rb-12 mb-12 w-full max-w-lg md:mb-18 lg:mb-20">
          <div className="w-full max-w-lg">
            ...
            <p className="md:text-md">
              Stories and strategies for modern hospitality
            </p>
          </div>
        </div>
        <div className="flex flex-col justify-start">
            ...
            <div className="flex h-full flex-col items-start justify-center">
              ...
              <a className="mb-2" href="#">
                <h3 className="mb-2 text-2xl font-bold md:text-3xl md:leading-[1.3] lg:text-4xl">
                  The housekeeping revolution is here
                </h3>
              </a>
              <p>
                How digital workflows transform your cleaning operations from
                chaos to precision
              </p>
              <Button
                title="Read more"
          ...
          <div className="grid grid-cols-1 gap-x-8 gap-y-12 md:grid-cols-2 md:gap-y-16 lg:grid-cols-3">
            <div className="flex size-full flex-col items-start justify-start text-start">
              ...
              <a className="mb-2 flex justify-start text-start" href="#">
                <h2 className="text-xl font-bold md:text-2xl">
                  Direct bookings beat the OTA game
                </h2>
              </a>
              <p>
                Why commission-free bookings matter more than you think in
                today's market
              </p>
              <Button
                title="Read more"
            ...
            <div className="flex size-full flex-col items-start justify-start text-start">
              ...
              <a className="mb-2 flex justify-start text-start" href="#">
                <h2 className="text-xl font-bold md:text-2xl">
                  Mobile keys changed everything
                </h2>
              </a>
              <p>
                The guest experience starts before they arrive at your front
                desk
              </p>
              <Button
                title="Read more"
            ...
            <div className="flex size-full flex-col items-start justify-start text-start">
              ...
              <a className="mb-2 flex justify-start text-start" href="#">
                <h2 className="text-xl font-bold md:text-2xl">
                  AI at the front desk works
                </h2>
              </a>
              <p>
                Real hotels, real results, real guests getting answers in
                seconds
              </p>
              <Button
                title="Read more"
            ...
            <div className="flex size-full flex-col items-start justify-start text-start">
              ...
              <a className="mb-2 flex justify-start text-start" href="#">
                <h2 className="text-xl font-bold md:text-2xl">
                  Channel management without the headache
                </h2>
              </a>
              <p>
                Sync rates and availability across sixty platforms in real time,
                not manually
              </p>
              <Button
                title="Read more"
            ...
            <div className="flex size-full flex-col items-start justify-start text-start">
              ...
              <p>
                Handle cards, virtual charges, and pre-authorizations without
                the friction
              </p>
              <Button
                title="Read more"
            ...
            <div className="flex size-full flex-col items-start justify-start text-start">
              ...
              <a className="mb-2 flex justify-start text-start" href="#">
                <h2 className="text-xl font-bold md:text-2xl">
                  Check-in happens on their phone now
                </h2>
              </a>
              <p>
                Digital ID scanning and smartphone room keys are no longer nice
                to have
              </p>
              <Button
                title="Read more"
