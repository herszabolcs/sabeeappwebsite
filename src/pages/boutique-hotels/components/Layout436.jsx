          ...
          <div className="flex flex-col items-end">
            ...
            <div className="ml-[5%] mr-[10%] mt-12 md:mt-18 lg:mt-20">
              ...
              <p className="md:text-md">
                The PMS captures preferences, dietary needs, and past stays in
                one profile. Your team sees it all at a glance, and every
                interaction builds on what came before. That's how boutique
                hotels create moments that matter.
              </p>
