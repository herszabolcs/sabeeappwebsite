    ...
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28 scheme-3">
      <div className="container">
        <div className="mx-auto mb-12 max-w-lg text-center md:mb-18 lg:mb-20">
          <p className="mb-3 font-semibold md:mb-4">Guest experience</p>
          <h1 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
            Every touchpoint becomes an opportunity
          </h1>
          <p className="md:text-md">
            GuestAdvisor puts your property in your guests' hands from the
            moment they book. Digital check-in, room keys on their phone, and
            upsells that feel like suggestions from a friend. The AI Front Desk
            Agent handles routine questions while your team focuses on the
            personal touches that define boutique hospitality.
          </p>
            ...
            >
              ...
              >
                <p className="mt-3 md:mt-4">
                  Guests check in from their phone, scan their ID, and unlock
                  their room without a desk interaction. You save time. They
                  feel in control.
                </p>
              </motion.div>
            </div>
