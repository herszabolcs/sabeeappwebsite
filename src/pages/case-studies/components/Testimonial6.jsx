      ...
      <div className="container">
        <div className="mb-12 w-full md:mb-18 lg:mb-20">
          ...
          <p className="md:text-md">
            The people running these properties know what works. Listen to them.
          </p>
        </div>
        <div className="grid grid-cols-1 gap-y-12 md:grid-cols-3 md:gap-x-8 lg:gap-x-12 lg:gap-y-16">
          <div className="flex h-full max-w-lg flex-col items-start justify-start text-left">
            ...
            <blockquote className="text-md font-bold leading-[1.4] md:text-xl">
              "We went from chaos to control. SabeeApp gave us back our nights."
            </blockquote>
          ...
          <div className="flex h-full max-w-lg flex-col items-start justify-start text-left">
            ...
            <blockquote className="text-md font-bold leading-[1.4] md:text-xl">
              "Direct bookings jumped 35% in three months. The commission
              savings alone paid for the software."
            </blockquote>
            <div className="mt-6 flex w-full flex-col md:mt-8 md:w-auto">
              <div className="mb-4">
                <img
              ...
              <div className="mb-3 md:mb-4">
                ...
                <p>Manager, London vacation rental</p>
              </div>
              <div className="hidden w-px self-stretch bg-black md:block" />
              <div>
                <img
          ...
          <div className="flex h-full max-w-lg flex-col items-start justify-start text-left">
            ...
            <blockquote className="text-md font-bold leading-[1.4] md:text-xl">
              "Our housekeeping team moves faster now. No more confusion about
            ...
            <div className="mt-6 flex w-full flex-col md:mt-8 md:w-auto">
              ...
              <div className="mb-3 md:mb-4">
                ...
                <p>Operations director, Rome property</p>
              </div>
              <div className="hidden w-px self-stretch bg-black md:block" />
              <div>
                <img
