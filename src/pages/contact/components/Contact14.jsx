      ...
      <div className="container">
        <div className="rb-12 mb-12 max-w-lg md:mb-18 lg:mb-20">
          ...
          <p className="md:text-md">
            We answer quickly and know hospitality inside out.
          </p>
        </div>
        <div className="grid auto-cols-fr grid-cols-1 gap-x-12 gap-y-12 md:grid-cols-[0.5fr_1fr] md:gap-x-20 md:gap-y-16">
          <div className="grid auto-cols-fr grid-cols-1 gap-x-4 gap-y-10">
            ...
            <div>
              ...
              <p className="mb-2">Talk to someone directly</p>
              <a className="underline" href="#">
                +61 2 8011 8011
              </a>
            </div>
            <div>
              ...
              <p className="mb-2">
                Level 2, 50 Holt Street, Surry Hills NSW 2010
              </p>
          ...
          <a href="#" className="justify-self-end md:w-[321.6px] lg:w-auto">
            <img
              ...
              className="rounded-image size-full h-[400px] object-cover md:h-[516px]"
            />
          </a>
        </div>
      </div>
