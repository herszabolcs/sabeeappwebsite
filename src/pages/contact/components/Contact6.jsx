    ...
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28 scheme-3">
      <div className="container grid grid-cols-1 items-start gap-y-12 md:grid-flow-row md:grid-cols-2 md:gap-x-12 lg:grid-flow-col lg:gap-x-20 lg:gap-y-16">
        <div>
          ...
          <div className="grid grid-cols-1 gap-4 py-2">
            ...
            <div className="flex items-center gap-4">
              ...
              <p>Level 2, 50 Holt Street, Surry Hills NSW 2010</p>
            </div>
          </div>
        </div>
        <form className="grid max-w-lg grid-cols-1 grid-rows-[auto_auto] gap-6">
          ...
          <div className="grid w-full items-center">
            <Label className="mb-2">What can we help?</Label>
            <Select>
              <SelectTrigger>
          ...
          <div className="grid w-full items-center py-3 md:py-4">
            ...
            <RadioGroup className="grid grid-cols-2 gap-x-6 gap-y-3.5">
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="Hotel owner" id="#first_choice" />
                <Label htmlFor="#first_choice">Hotel owner</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="First choice" id="#second_choice" />
                <Label htmlFor="#second_choice">Front desk manager</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="First choice" id="#third_choice" />
                <Label htmlFor="#third_choice">Housekeeping manager</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="First choice" id="#fourth_choice" />
                <Label htmlFor="#fourth_choice">General manager</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="First choice" id="#fifth_choice" />
                <Label htmlFor="#fifth_choice">Booking agent</Label>
              </div>
              <div className="flex items-center space-x-2">
