...
export function Layout513() {
  ...
  return (
    <section
      ...
      id="relume"
      className="px-[5%] py-16 md:py-24 lg:py-28 scheme-2 btn-light alternate logo-alt"
    >
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:items-start md:gap-20">
          <div className="flex flex-col gap-y-16 md:sticky md:top-20 md:mt-20 md:h-[calc(100vh_-10rem)] md:justify-center">
            <div className="flex flex-col">
              <p className="mb-3 font-semibold md:mb-4">By role</p>
              <h2 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
                Built for how you actually work
              </h2>
              <p className="md:text-md">
                Every role in hospitality has different needs. SabeeApp meets
                you where you are.
              </p>
              ...
              <AnimatePresence>
                <Fragment>
                  <ConditionalRender condition={mobile.isMobile}>
                    <div>
                      <h5 className="mb-3 text-xl font-bold">Hotel owners</h5>
                      <p>
                        Check-in, reservations, and guest folios in one place,
                ...
                <Fragment>
                  <ConditionalRender condition={mobile.isMobile}>
                    <div>
                      ...
                      <p>
                        Multi-property oversight, staff management, and
