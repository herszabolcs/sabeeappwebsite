      ...
      <div className="container flex flex-col items-start">
        <div className="rb-12 mb-12 w-full max-w-lg md:mb-18 lg:mb-20">
          ...
          <p className="md:text-md">
            Hotels using GuestAdvisor see measurable shifts in how guests move
            through their stay. Friction disappears. Revenue appears.
          </p>
        </div>
        <Tabs
          defaultValue="tab-1"
          ...
          <TabsList className="col-start-1 col-end-2 row-start-1 row-end-2 grid grid-cols-1 items-center gap-x-4 gap-y-10">
            ...
            >
              ...
              <h3 className="text-md font-bold leading-[1.4] md:text-xl">
                Guests complete online check-in
              </h3>
              <p className="mt-2">
                Adoption rates that prove guests want control
              </p>
            </TabsTrigger>
            <TabsTrigger
              value="tab-2"
