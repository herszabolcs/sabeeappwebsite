      ...
      <div className="container">
        <div className="mx-auto mb-12 max-w-lg text-center md:mb-18 lg:mb-20">
          ...
          <h1 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
            Assign beds and rooms with complete control
          </h1>
          <p className="md:text-md">
            Dorm beds, private rooms, and everything in between. SabeeApp gives
            you one calendar to manage it all, with instant visibility into
            what's booked, what's available, and who's checking in today.
          </p>
            ...
            >
              ...
              >
                <p className="mt-3 md:mt-4">
                  Drag and drop beds into your dorms. See occupancy at a glance.
                  No overbooking, no confusion.
                </p>
              </motion.div>
            </div>
            <div
