      ...
      <div className="container max-w-lg">
        <div className="mx-auto mb-8 max-w-lg text-center md:mb-10 lg:mb-12">
          ...
          <p className="md:text-md">
            No hidden fees. No surprise charges. Just what you need to run your
            property.
          </p>
        </div>
            ...
            <div className="h-full border border-border-primary px-6 py-8 md:p-8">
              ...
              <div className="mb-8 mt-4 grid grid-cols-1 gap-y-4 py-2">
                <div className="flex self-start">
                  ...
                  <p>Reservations and calendar</p>
                </div>
                <div className="flex self-start">
                  <div className="mr-4 flex-none self-start">
                    <BiCheck className="size-6" />
                  </div>
                  <p>Guest check-in and profiles</p>
                </div>
                <div className="flex self-start">
                  <div className="mr-4 flex-none self-start">
                    <BiCheck className="size-6" />
