        ...
        <div className="flex flex-col gap-5 md:flex-row md:gap-12 lg:gap-20">
          ...
          <div className="w-full max-w-lg">
            <p className="md:text-md">
              SabeeApp brings every operation into a single, unified platform.
              No more switching between tools. No more lost data. Just clean,
              connected workflows that let your team focus on what matters.
            </p>
