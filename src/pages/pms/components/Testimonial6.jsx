    ...
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28 scheme-3">
      <div className="container">
        <div className="mb-12 w-full md:mb-18 lg:mb-20">
          ...
          <p className="md:text-md">Real stories from real hotels</p>
        </div>
        <div className="grid grid-cols-1 gap-y-12 md:grid-cols-3 md:gap-x-8 lg:gap-x-12 lg:gap-y-16">
          <div className="flex h-full max-w-lg flex-col items-start justify-start text-left">
            ...
            <blockquote className="text-md font-bold leading-[1.4] md:text-xl">
              "We cut our front desk workload in half. The calendar alone saved
              us hours every single day."
            </blockquote>
          ...
          <div className="flex h-full max-w-lg flex-col items-start justify-start text-left">
            ...
            <blockquote className="text-md font-bold leading-[1.4] md:text-xl">
              "No more double bookings. No more manual syncing. Everything just
              works."
            </blockquote>
            <div className="mt-6 flex w-full flex-col md:mt-8 md:w-auto">
              <div className="mb-4">
              ...
              <div className="mb-3 md:mb-4">
                ...
                <p>Owner, independent property</p>
              </div>
              <div className="hidden w-px self-stretch bg-black md:block" />
              <div>
                <img
          ...
          <div className="flex h-full max-w-lg flex-col items-start justify-start text-left">
            ...
            <blockquote className="text-md font-bold leading-[1.4] md:text-xl">
              "Our team actually likes using it. That's when you know you've
            ...
            <div className="mt-6 flex w-full flex-col md:mt-8 md:w-auto">
              ...
              <div className="mb-3 md:mb-4">
                ...
                <p>Operations director, multi-property</p>
              </div>
              <div className="hidden w-px self-stretch bg-black md:block" />
              <div>
                <img
