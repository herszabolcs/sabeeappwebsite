            ...
            <div className="flex flex-col items-end md:h-screen md:justify-center">
              <div className="mx-[5%] max-w-md md:ml-[5vw] md:mr-12 lg:mr-20">
                ...
                <h2 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
                  Where SabeeApp pulls ahead
                </h2>
                <p className="md:text-md">
                  The details matter when you're running a hotel. SabeeApp
                  handles the work that Little Hotelier leaves to you, freeing
                  your team to focus on guests instead of spreadsheets.
                </p>
        ...
        <div>
          <div className="sticky top-0 flex h-screen flex-col justify-center p-10">
            <div className="max-w-md text-text-alternative">
              ...
              <p>
                Rates and availability update across sixty-plus OTAs instantly.
                No manual uploads. No rate parity headaches. Your inventory
                stays accurate everywhere, all the time.
              </p>
            </div>
